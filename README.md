...
```bash
git clone https://github.com/yourusername/youtube-transcript-nlp-app.git
cd youtube-transcript-nlp-app
```
...
- **Email:** romil@example.com *(replace with your actual email)*
